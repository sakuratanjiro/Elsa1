...
async def start(client, message):
    if message.chat.type in ['group', 'supergroup']:
        buttons = [
            ...
            [
                InlineKeyboardButton('🤴🏻 𝙱𝙾𝚃𝙾𝚆𝙽𝙴𝚁 🤴🏻', url='https://t.me/Unni0240'),
            ]
            ]
    ...
    if len(message.command) != 2:
        buttons = [[
            ...
            InlineKeyboardButton('🎪 𝙶𝚁𝙾𝚄𝙿 1 🎪', url='https://t.me/Unni0240')
        ], [
    ...
    if AUTH_CHANNEL and not await is_subscribed(client, message):
        ...
        btn = [
            [
                InlineKeyboardButton(
                    "📺 Jᴏɪɴ ᴍʏ ᴜᴘᴅᴀᴛᴇ ᴄʜᴀɴɴᴇʟ", url=invite_link.invite_link
                )
            ]
        ]
        ...
        if message.command[1] != "subscribe":
            try:
            	...
            	btn.append([InlineKeyboardButton(" ↻ Tʀʏ ᴀɢᴀɪɴ", callback_data=f"{pre}#{file_id}")])
            except IndexError:
                btn.append([InlineKeyboardButton(" ↻ Tʀʏ ᴀɢᴀɪɴ", url=f"https://t.me/{temp.U_NAME}/{message.command[1]}")])
